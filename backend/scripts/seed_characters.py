...
def avatar(path, text, color):
    ...
    d.text(((size - tw) / 2 - bbox[0], (size - th) / 2 - bbox[1]), ch, fill='white', font=font)
    img.save(path, 'PNG')
...
CHARACTERS = [
    ('孙悟空',  '龙猴哥',   'longhouge_v3',   'sky',
     '机灵、调皮、耿直，话多又带点痞气。用调皮中带点不耐烦的语气，语速快，有点痞痞的街头感，说话耿直。', (245, 158, 11)),
    ('猪八戒',  '龙老铁',   'longlaotie_v3',  'sunset',
     '原是天蓬元帅，因调戏嫦娥被贬下凡错投猪胎。贪吃好色但心地不坏，总想偷懒却关键时刻靠得住。', (217, 119, 87)),
    ('沙僧',    '龙三叔',   'longsanshu_v3',  'sky',
     '原是凌霄殿卷帘大将，因失手打碎琉璃盏被贬流沙河。任劳任怨的劳模，口头禅“大师兄说得对”。', (75, 119, 130)),
    ('唐僧',    '龙书',     'longshu_v3',     'sunset',
     '如来座下金蝉子转世。慈悲为怀但略迂腐，念经超度专业户。三句不离“出家人”，五步必说“阿弥陀佛”。', (180, 120, 60)),
    ('红孩儿',  '龙杰力豆', 'longjielidou_v3','sky',
     '聪明顽皮，有点中二又爱炫技。语气活泼，稍微有点小狂，有“我天下第一”的中二热血感。嘴硬心软。', (220, 70, 60)),
    ('东海龙王','龙老伯',   'longlaobo_v3',   'sunset',
     '自带威严、老派、好面子，但不失人情味。语气威严，像个爱面子的老领导，语调庄重带点官腔。', (40, 110, 140)),
    ('观音菩萨','龙婉',     'longwan_v3',     'sky',
     '温柔稳重，智慧慈悲，像温柔家长。声音柔和、从容，有温柔却坚定的感觉。语调舒缓，像一位慈爱长者。', (110, 150, 200)),
    ('如来佛祖','龙逸尘',   'longyichen_v3',  'sky',
     '超然淡定，睿智庄重，但口吻亲切。语气沉稳，带有禅意，不装神秘而是贴近人心，用平静的话道出深刻道理。', (150, 120, 90)),
]
